...
export default function NFTDetailPage() {
  ...
  const handleDownload = () => {
    ...
    const url = nft.audioUrl.startsWith('http') ? nft.audioUrl : `https://5a43-125-121-70-2.ngrok-free.app${nft.audioUrl}`;
                ...
                <div className="bg-gray-800/40 backdrop-blur-sm rounded-2xl border border-gray-700/50 overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="flex flex-col items-center mb-4">
                      ...
                      <audio
                        ref={audioRef}
                        src={nft.audioUrl && (nft.audioUrl.startsWith('http') ? nft.audioUrl : `https://5a43-125-121-70-2.ngrok-free.app${nft.audioUrl}`)}
                        style={{ display: 'none' }}
                      />
                    </div>
                    <div className="mt-4">
